...
namespace PhotoboothBranchService.Api.Controllers
{
    public class PhotoBoothBranchesController : ControllerBaseApi
    {
        ...
        //[HttpGet]
        //public async Task<ActionResult<IEnumerable<PhotoBoothBranch>>> GetAllPhotoBoothBranches(CancellationToken cancellationToken)
        //{
        //    try
        //    {
        ...
        //public async Task<ActionResult<IEnumerable<PhotoBoothBranch>>> GetPhotoBoothBranchesByStatus(ManufactureStatus status, CancellationToken cancellationToken)
        //{
        //    try
        //    {
        ...
        //[HttpGet("name/{name}")]
        //public async Task<ActionResult<IEnumerable<PhotoBoothBranch>>> GetPhotoBoothBranchesByName(string name, CancellationToken cancellationToken)
        //{
        //    try
        //    {
        ...
        //[HttpPost]
        //public async Task<ActionResult> CreatePhotoBoothBranch(PhotoBoothBranch photoBoothBranch, CancellationToken cancellationToken)
        //{
        //    try
        //    {
        ...
        //[HttpGet("{id}")]
        //public async Task<ActionResult<PhotoBoothBranch>> GetPhotoBoothBranchById(Guid id, CancellationToken cancellationToken)
        //{
        //    try
        //    {
        ...
        //[HttpPut("{id}")]
        //public async Task<ActionResult> UpdatePhotoBoothBranch(Guid id, PhotoBoothBranch photoBoothBranch, CancellationToken cancellationToken)
        //{
        //    try
        //    {
