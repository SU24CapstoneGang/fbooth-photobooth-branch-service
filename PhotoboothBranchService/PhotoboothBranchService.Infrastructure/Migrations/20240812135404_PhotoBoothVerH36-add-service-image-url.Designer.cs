...
namespace PhotoboothBranchService.Infrastructure.Migrations
{
    ...
    [Migration("20240812135404_PhotoBoothVerH36-add-service-image-url")]
    partial class PhotoBoothVerH36addserviceimageurl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 8, 12, 13, 54, 4, 694, DateTimeKind.Utc).AddTicks(3465),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 8, 12, 13, 54, 4, 694, DateTimeKind.Utc).AddTicks(3467),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 8, 12, 13, 54, 4, 694, DateTimeKind.Utc).AddTicks(3469),
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CouldID = "",
                            CreatedDate = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6832),
                            LastModified = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6841),
                        ...
                        new
                        {
                            ...
                            CouldID = "",
                            CreatedDate = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6845),
                            LastModified = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6846),
                        ...
                        new
                        {
                            ...
                            CouldID = "",
                            CreatedDate = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6849),
                            LastModified = new DateTime(2024, 8, 12, 20, 54, 4, 696, DateTimeKind.Local).AddTicks(6849),
