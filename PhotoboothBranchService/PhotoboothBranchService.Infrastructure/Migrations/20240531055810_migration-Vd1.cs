        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 34, DateTimeKind.Utc).AddTicks(8694)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 38, DateTimeKind.Utc).AddTicks(767)),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 38, DateTimeKind.Utc).AddTicks(3412)),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 40, DateTimeKind.Utc).AddTicks(7406)),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 37, DateTimeKind.Utc).AddTicks(1368)),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ThemeFilterID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 37, DateTimeKind.Utc).AddTicks(8558)),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ThemeFrameID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 41, DateTimeKind.Utc).AddTicks(5301)),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ThemeStickerID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 5, 31, 5, 58, 10, 37, DateTimeKind.Utc).AddTicks(6200)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1b4f2a3e-7d94-4119-8b6d-5c15b02848f6"), new DateTime(2024, 5, 31, 5, 58, 10, 38, DateTimeKind.Utc).AddTicks(3654), "VNPay", "Active" },
                    { new Guid("f3b6e6b2-f90e-4f6b-8cd2-68b467afae0f"), new DateTime(2024, 5, 31, 5, 58, 10, 38, DateTimeKind.Utc).AddTicks(3657), "MoMo", "Active" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2f3d2f4b-8370-4b12-8e5c-1e38c3f9bace"), "Manager" },
                    { new Guid("4a1f17f8-c66f-4c6e-a0c2-8b95b8d4e5bb"), "Admin" },
                    { new Guid("9d7c0f8b-cb6f-4894-8e91-b5b594c1c37c"), "Customer" },
                    { new Guid("e82f0f61-4488-4b18-bf68-540704917e6a"), "BranchManager" }
                });
