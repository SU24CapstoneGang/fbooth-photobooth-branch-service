...
namespace PhotoboothBranchService.Infrastructure.Migrations
{
    ...
    [Migration("20240609204225_PhotoBoothVerH1")]
    partial class PhotoBoothVerH1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Filter", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 281, DateTimeKind.Utc).AddTicks(8237));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Frame", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 282, DateTimeKind.Utc).AddTicks(1352));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Layout", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 282, DateTimeKind.Utc).AddTicks(6470));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.PaymentMethod", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 283, DateTimeKind.Utc).AddTicks(3871));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 9, 20, 42, 25, 283, DateTimeKind.Utc).AddTicks(4613),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 9, 20, 42, 25, 283, DateTimeKind.Utc).AddTicks(4621),
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.PhotoSession", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 286, DateTimeKind.Utc).AddTicks(5316));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.SessionOrder", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 301, DateTimeKind.Utc).AddTicks(1037));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Sticker", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 9, 20, 42, 25, 301, DateTimeKind.Utc).AddTicks(4519));
