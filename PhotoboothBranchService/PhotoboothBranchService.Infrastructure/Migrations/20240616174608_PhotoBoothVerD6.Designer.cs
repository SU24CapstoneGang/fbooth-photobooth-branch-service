...
namespace PhotoboothBranchService.Infrastructure.Migrations
{
    ...
    [Migration("20240616174608_PhotoBoothVerD6")]
    partial class PhotoBoothVerD6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Frame", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 754, DateTimeKind.Utc).AddTicks(6301));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Layout", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 755, DateTimeKind.Utc).AddTicks(591));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.PaymentMethod", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 756, DateTimeKind.Utc).AddTicks(485));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 16, 17, 46, 8, 756, DateTimeKind.Utc).AddTicks(1534),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 6, 16, 17, 46, 8, 756, DateTimeKind.Utc).AddTicks(1537),
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Photo", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 759, DateTimeKind.Utc).AddTicks(9500));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.PhotoSession", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 760, DateTimeKind.Utc).AddTicks(2666));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.SessionOrder", b =>
                {
                    ...
                    b.Property<DateTime>("StartTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 769, DateTimeKind.Utc).AddTicks(6553));
            ...
            modelBuilder.Entity("PhotoboothBranchService.Domain.Entities.Sticker", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 16, 17, 46, 8, 770, DateTimeKind.Utc).AddTicks(8388));
