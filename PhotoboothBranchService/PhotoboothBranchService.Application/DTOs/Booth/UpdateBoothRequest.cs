...
namespace PhotoboothBranchService.Application.DTOs.Booth
{
    ...
    {
        [StringLength(50, MinimumLength = 8, ErrorMessage = "Booth name must between 8 to 50 char characters")]
        [RegularExpression(@"^[a-zA-Z0-9\s]*$", ErrorMessage = "Booth name must not having special characters.")]
        public string? BoothName { get; set; }
        [StringLength(50, MinimumLength = 8, ErrorMessage = "Background color must between 8 to 50 char characters")]
