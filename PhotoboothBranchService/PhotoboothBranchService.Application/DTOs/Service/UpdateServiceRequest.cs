...
namespace PhotoboothBranchService.Application.DTOs.Service
{
    ...
    {
        [StringLength(100, MinimumLength = 8, ErrorMessage = "Service name must between 8 to 100 char characters.")]
        [RegularExpression(@"^[a-zA-Z0-9\s]*$", ErrorMessage = "Service name must not having special characters.")]
        public string? ServiceName { get; set; }
        [StringLength(255, MinimumLength = 8, ErrorMessage = "Description must between 8 to 255 char characters.")]
        ...
        [StringLength(30, MinimumLength = 8, ErrorMessage = "Unit must between 8 to 30 char characters.")]
