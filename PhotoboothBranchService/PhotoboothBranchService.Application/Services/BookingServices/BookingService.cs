...
public class BookingService : IBookingService
{
    ...
    public async Task<BookingResponse> ValidateBookingService(ValidateSessionOrderRequest validateSessionPhotoRequest)
    {
        ...
        if (sessionOrders.Count() == 0 && booth != null)
        {
            ...
            //    await _boothRepository.UpdateAsync(booth);
                return _mapper.Map<BookingResponse>(sessionOrder);
            //}
            //else
            //{
