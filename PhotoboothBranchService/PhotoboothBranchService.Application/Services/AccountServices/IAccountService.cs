...
{
    public interface IAccountService : IServiceBase<AccountResponse, CreateAccountRequestModel, AccountRegisterResponse, UpdateAccountRequestModel, AccountFilter, PagingModel>
    {
